...
Next theorem shows that every half-duplex protocol with zero or with adversary can be transformed
...
Almost the same technique can be used for half-duplex protocols. 
